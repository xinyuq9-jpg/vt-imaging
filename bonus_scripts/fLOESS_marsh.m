function [smoothed] = fLOESS_marsh(noisy,span, newx) 
%
% Author; Gabriel Marsh
% Latest revision; 
% 22/02/2016    Included non-uniformly spaced x-data capability
% 26/04/2022    Belyk: Added manually specifified xvalues for predictions
...
fitted = zeros(n,1); % pre-allocate space
for i = 1:n
    ...
    fitted(i) = CC(1) + CC(2)*x(i) + CC(3)*x(i).^2;
    
end

smoothed = interp1(x,fitted,newx, 'spline');
end
